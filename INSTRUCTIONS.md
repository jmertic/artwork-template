...
`<project full name>` is the display name for the project ( e.g. 'Kubernetes' )

`<project name>` is the name of the project in the filesystem ( e.g. 'kubernetes' )

1. Add a new directory under the directory for the category with the artwork. Artwork directory structure should map as follows...
